          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="车票关键信息" name="first">
              ...
              >
                ...
                <el-table-column label="register" width="190px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[2 ] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="fund" width="180px">
                  <template slot-scope="scope">
                ...
                <el-table-column label="including" width="180px">
                  <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    update(e) {
      ...
      axios
        .post(this.server_url + "/upload4", param, config)
        .then((response) => {
          this.percentage = 100;
          clearInterval(timer);
          ...
          this.feat_list1 = Object.keys(response.data.business_info);
          ...
          for (var i = 0; i < this.feat_list1.length; i++) {
            response.data.business_info[this.feat_list1[i]][7] = this.feat_list1[i];
            this.business_list.push(response.data.business_info[this.feat_list1[i]]);
          }

          this.business_list.push(response.data.business_info);
          this.business_list_1 = this.business_list[0];
          this.dialogTableVisible = false;
          this.percentage = 0;
          this.notice1();

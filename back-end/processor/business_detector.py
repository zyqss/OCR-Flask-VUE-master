...
def getCanny(image):
    ...
    # 二值图
    cv2.imwrite('business_output/binary.jpg', binary)
    return binary
...
def imagePreProcessing2(path):
    ...
    cv2.imwrite("business_output/outline.jpg", image)
